import { Checkbox, FormControl, FormGroup, FormLabel, List, ListItem, ListItemIcon, ListItemText } from '@material-ui/core';
...
const ExpenseFormUserList: React.FC<ExpenseFormUserListParams> = ({
    ...
    const meetingParticipantList = useAppSelector(expensesMeetingParticipantSelector);
        ...
        <FormLabel component="legend">Select payees</FormLabel>
            <FormGroup>
                <List className={classes.listRoot}>
                    {meetingParticipantList !== null && meetingParticipantList.map((user) => {
